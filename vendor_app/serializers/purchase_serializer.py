...
from vendor_app.services.purchase import purchase_create_update_service_serializer
...
class HeadPurchaseOrderSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, data):
        data = super(HeadPurchaseOrderSerializer).to_representation(data)
...
class PurchaseOrderGetRequestSerailizer(serializers.ModelSerializer):
